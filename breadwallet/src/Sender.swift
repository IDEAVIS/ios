...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/primuscoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/primuscoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/primuscoin-paymentack" && data.count <= 50000 {
