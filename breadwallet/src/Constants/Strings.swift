...
enum S {
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value:"Camera Flash", comment: "Scan Primuscoin address camera flash toggle")
    }
    ...
    enum Send {
        ...
        static let invalidAddressMessage = NSLocalizedString("Send.invalidAddressMessage", value:"The destination address is not a valid Primuscoin address.", comment: "Invalid address alert message")
        static let invalidAddressOnPasteboard = NSLocalizedString("Send.invalidAddressOnPasteboard", value: "Pasteboard does not contain a valid Primuscoin address.", comment: "Invalid address on pasteboard message")
        ...
        enum UsedAddress {
            ...
            static let firstLine = NSLocalizedString("Send.UsedAddress.firstLine", value: "Primuscoin addresses are intended for single use only.", comment: "Adress already used alert message - first part")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access IdeavisWallet's keychain data and steal your Primuscoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access IdeavisWallet's keychain data and steal your Primuscoin. Please only use IdeavisWallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum TransactionDetails {
        ...
        static let txHashHeader = NSLocalizedString("TransactionDetails.txHashHeader", value:"Primuscoin Transaction ID", comment: "Transaction ID header")
    ...
    enum UpdatePin {
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value:"Remember this PIN. If you forget it, you won't be able to access your Primuscoin.", comment: "Update PIN caption text")
    ...
    enum DefaultCurrency {
        ...
        static let bitcoinLabel = NSLocalizedString("DefaultCurrency.bitcoinLabel", value: "Primuscoin Display Unit", comment: "Primuscoin denomination picker label")
    }
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the Primuscoin network but not in your IdeavisWallet.", comment: "Syncing explanation")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value:"Request an Amount", comment: "Request a specific amount of Primuscoin")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy Primuscoin", comment: "Buy Primuscoin title")
    }
    ...
    enum StartViewController {
        ...
        static let message = NSLocalizedString("StartViewController.message", value: "The most secure and safest way to use Primuscoin.", comment: "Start view message")
    }
    ...
    enum PaymentProtocol {
        enum Errors {
            ...
            static let smallPayment = NSLocalizedString("PaymentProtocol.Errors.smallPayment", value: "Primuscoin payments can't be less than %1$@.", comment: "Amount too small error message")
            static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "Primuscoin transaction outputs can't be less than $@.", comment: "Output too small error message.")
    ...
    enum Import {
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The Primuscoin network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your Primuscoin wallet", comment: "<sitename> is requesting authentication using your Primuscoin wallet")
    ...
    enum NodeSelector {
        ...
        static let title = NSLocalizedString("NodeSelector.title", value: "Primuscoin Nodes", comment: "Node Selector view title")
