...
enum S {
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access PrimusWallet's keychain data and steal your Litecoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access PrimusWallet's keychain data and steal your Litecoin. Please only use PrimusWallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the Litecoin network but not in your PrimusWallet.", comment: "Syncing explanation")
