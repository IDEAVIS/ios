...
enum S {
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value:"PrimusWallet is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access PrimusWallet's keychain data and steal your Primuscoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access PrimusWallet's keychain data and steal your Primuscoin. Please only use PrimusWallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value:"Protects your PrimusWallet from unauthorized users.", comment: "PIN button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value:"Your PIN will be used to unlock your PrimusWallet and send money.", comment: "PIN creation info.")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value:"Recover your PrimusWallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My PrimusWallet", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let label = NSLocalizedString("TouchIdSettings.label", value:"Use your fingerprint to unlock your PrimusWallet and send money up to a set limit.", comment: "Touch Id screen label")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value:"Enable Touch ID for PrimusWallet", comment: "Touch id switch label.")
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying PrimusWallet?", comment: "Are you enjoying PrimusWallet alert message body")
    ...
    enum About {
        ...
        static let footer = NSLocalizedString("About.footer", value:"Made by the global PrimusWallet team. Version %1$@", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let body = NSLocalizedString("PushNotifications.body", value:"Turn on notifications to receive special messages from PrimusWallet in the future.", comment: "Push notifications settings view body")
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the Primuscoin network but not in your PrimusWallet.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value:"Help improve PrimusWallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum StartPaperPhrase {
        static let body = NSLocalizedString("StartPaperPhrase.body", value:"Your paper key is the only way to restore your PrimusWallet if your phone is lost, stolen, broken, or upgraded.\n\nWe will show you a list of words to write down on a piece of paper and keep safe.", comment: "Paper key explanation text.")
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the PrimusWallet iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "PrimusWallet has upgraded to using a 6-digit PIN. Tap here to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = NSLocalizedString("Prompts.ShareData.body", value: "Help improve PrimusWallet by sharing your anonymous data with us", comment: "Share data prompt body")
        }
        enum FaceId {
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "PrimusWallet does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your PrimusWallet Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your PrimusWallet wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different PrimusWallet wallet on this device.", comment: "Start wipe wallet view message")
