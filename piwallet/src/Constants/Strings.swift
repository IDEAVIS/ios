...
enum S {
  ...
  enum Symbols {
    ...
    static func currencyButtonTitle(maxDigits: Int) -> String {
      switch maxDigits {
      case 2:
        return "subIVC\(S.Symbols.narrowSpace)(\(S.Symbols.bits))"
      case 5:
        return "mIVC\(S.Symbols.narrowSpace)(m\(S.Symbols.bits))"
      case 8:
  ...
  enum Scanner {
    static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value: "Camera Flash", comment: "Scan Ideaviscoin address camera flash toggle")
  }
  ...
  enum Send {
    ...
    static let invalidAddressMessage = NSLocalizedString("Send.invalidAddressMessage", value: "The destination address is not a valid Ideaviscoin address.", comment: "Invalid address alert message")
    static let invalidAddressOnPasteboard = NSLocalizedString("Send.invalidAddressOnPasteboard", value: "Pasteboard does not contain a valid Ideaviscoin address.", comment: "Invalid address on pasteboard message")
    ...
    static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value: "IdeavisWallet is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum UsedAddress {
      ...
      static let firstLine = NSLocalizedString("Send.UsedAddress.firstLine", value: "Ideaviscoin addresses are intended for single use only.", comment: "Adress already used alert message - first part")
  ...
  enum JailbreakWarnings {
    ...
    static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access IdeavisWallet's keychain data and steal your Ideaviscoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
    static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access IdeavisWallet's keychain data and steal your Ideaviscoin. Please only use IdeavisWallet on a non-jailbroken device.", comment: "Jailbreak warning message")
  ...
  enum TransactionDetails {
    ...
    static let txHashHeader = NSLocalizedString("TransactionDetails.txHashHeader", value: "Ideaviscoin Transaction ID", comment: "Transaction ID header")
  ...
  enum SecurityCenter {
    ...
    enum Cells {
      ...
      static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value: "Protects your IdeavisWallet from unauthorized users.", comment: "PIN button description")
  ...
  enum UpdatePin {
    ...
    static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value: "Your PIN will be used to unlock your IdeavisWallet and send money.", comment: "PIN creation info.")
    ...
    static let caption = NSLocalizedString("UpdatePin.caption", value: "Remember this PIN. If you forget it, you won't be able to access your Ideaviscoin.", comment: "Update PIN caption text")
  ...
  enum RecoverWallet {
    ...
    static let intro = NSLocalizedString("RecoverWallet.intro", value: "Recover your IdeavisWallet with your paper key.", comment: "Recover wallet intro")
  ...
  enum AccountHeader {
    static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value: "My IdeavisWallet", comment: "Default wallet name")
  ...
  enum TouchIdSettings {
    ...
    static let label = NSLocalizedString("TouchIdSettings.label", value: "Use your fingerprint to unlock your IdeavisWallet and send money up to a set limit.", comment: "Touch Id screen label")
    static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value: "Enable Touch ID for IdeavisWallet", comment: "Touch id switch label.")
  ...
  enum Settings {
    ...
    static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying IdeavisWallet?", comment: "Are you enjoying IdeavisWallet alert message body")
  ...
  enum About {
    ...
    static let footer = NSLocalizedString("About.footer", value: "Made by the global IdeavisWallet team. Version %1$@", comment: "About screen footer")
  }
  ...
  enum PushNotifications {
    ...
    static let body = NSLocalizedString("PushNotifications.body", value: "Turn on notifications to receive special messages from IdeavisWallet in the future.", comment: "Push notifications settings view body")
  ...
  enum DefaultCurrency {
    ...
    static let bitcoinLabel = NSLocalizedString("DefaultCurrency.bitcoinLabel", value: "Ideaviscoin Display Unit", comment: "Ideaviscoin denomination picker label")
  }

  enum SyncingView {
    static let syncing = NSLocalizedString("SyncingView.syncing", value: "Syncing", comment: "Syncing view syncing state header text")
    static let connecting = NSLocalizedString("SyncingView.connecting", value: "Connecting", comment: "Syncing view connecting state header text")
  }
  ...
  enum ShareData {
    ...
    static let body = NSLocalizedString("ShareData.body", value: "Help improve IdeavisWallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
  ...
  enum StartPaperPhrase {
    static let body = NSLocalizedString("StartPaperPhrase.body", value: "Your paper key is the only way to restore your IdeavisWallet if your phone is lost, stolen, broken, or upgraded.\n\nWe will show you a list of words to write down on a piece of paper and keep safe.", comment: "Paper key explanation text.")
  ...
  enum RequestAnAmount {
    static let title = NSLocalizedString("RequestAnAmount.title", value: "Request an Amount", comment: "Request a specific amount of Ideaviscoin")
  ...
  enum MenuButton {
    ...
    static let buy = NSLocalizedString("MenuButton.buy", value: "Buy Ideaviscoin", comment: "Buy Ideaviscoin title")
  }
  ...
  enum StartViewController {
    ...
    static let message = NSLocalizedString("StartViewController.message", value: "The most secure and safest way to use Ideaviscoin.", comment: "Start view message")
  }
  ...
  enum Watch {
    static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the IdeavisWallet iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
  }
  ...
  enum Prompts {
    ...
    enum UpgradePin {
      ...
      static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "IdeavisWallet has upgraded to using a 6-digit PIN. Tap here to upgrade.", comment: "Upgrade PIN prompt body.")
    }
    ...
    enum ShareData {
      ...
      static let body = NSLocalizedString("Prompts.ShareData.body", value: "Help improve IdeavisWallet by sharing your anonymous data with us", comment: "Share data prompt body")
    }
  ...
  enum PaymentProtocol {
    enum Errors {
      ...
      static let smallPayment = NSLocalizedString("PaymentProtocol.Errors.smallPayment", value: "Ideaviscoin payments can't be less than %1$@.", comment: "Amount too small error message")
      static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "Ideaviscoin transaction outputs can't be less than $@.", comment: "Output too small error message.")
  ...
  enum LocationPlugin {
    ...
    static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "IdeavisWallet does not have permission to access location services.", comment: "No permissions for location services")
  }
  ...
  enum Import {
    ...
    static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your IdeavisWallet Wallet", comment: "Caption for graphics")
    static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your IdeavisWallet wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The Ideaviscoin network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
  ...
  enum BitID {
    ...
    static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your Ideaviscoin wallet", comment: "<sitename> is requesting authentication using your Ideaviscoin wallet")
  ...
  enum WipeWallet {
    ...
    static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different IdeavisWallet wallet on this device.", comment: "Start wipe wallet view message")
  ...
  enum NodeSelector {
    ...
    static let title = NSLocalizedString("NodeSelector.title", value: "Ideaviscoin Nodes", comment: "Node Selector view title")
