...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/ideaviscoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/ideaviscoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/ideaviscoin-paymentack" && data.count <= 50000 {
